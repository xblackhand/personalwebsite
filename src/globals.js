...
export const checkbookAnywhereBodyText = 'The application was designed for users that checkbook their bank accounts to have a cross-platform way to store their transactions. Originally the webiste was coded using ASP.Net Core MVC, but now I have remade it using Reactjs to improve the user experience with client-side rendering through the use of React state and property updates.';
